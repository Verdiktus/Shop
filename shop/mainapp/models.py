...
class Smartphone(Product):
    ...
    sd_volume_max = models.CharField(max_length=255, verbose_name='Максимальный объем накопителя')
    main_cam_np = models.CharField(max_length=255, verbose_name='Главная камера')
    front_cam_np = models.CharField(max_length=255, verbose_name='Фронтальная камера')
